...
from biobb_pytorch.mdae.data import DictLoader, DictDataset
...
class DictModule(lightning.LightningDataModule):
    """Lightning DataModule constructed for :class:`~biobb_pytorch.mdae.data.dataset.DictDataset` .

    The DataModule automatically splits the :class:`~biobb_pytorch.mdae.data.dataset.DictDataset` s
    (using either random or sequential splitting) into training, validation, and (optionally)
    test sets.

    The class can also merge multiple :class:`~biobb_pytorch.mdae.data.dataset.DictDataset`s
    ...
    def __init__(
        ...
        """Create a ``DataModule`` wrapping a :class:`~biobb_pytorch.mdae.data.dataset.DictDataset`.
        ...
        See Also
        --------
        :class:`~biobb_pytorch.mdae.data.dataloader.DictLoader`
